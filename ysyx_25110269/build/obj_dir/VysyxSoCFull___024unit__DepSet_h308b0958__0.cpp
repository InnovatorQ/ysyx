...
VL_INLINE_OPT void VysyxSoCFull___024unit____Vdpiimwrap_skip_ref_TOP____024unit() {
    VL_DEBUG_IF(VL_DBG_MSGF("+        VysyxSoCFull___024unit____Vdpiimwrap_skip_ref_TOP____024unit\n"); );
    // Body
    skip_ref();
}
